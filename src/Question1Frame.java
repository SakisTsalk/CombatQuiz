...
public class Question1Frame extends JFrame{
	...
	public Question1Frame(AllQuestionsClass AllQuestions, double PlayerNumber,int TotalCorrectAnswers){
		...
		String QuestionName = q.getQuestion();
			...
			Answer1Button.addActionListener(new Answer1ButtonListener(CorrectAnswer,TotalCorrectAnswers,PlayerNumber));
			
			JButton Answer2Button = new JButton(" "+Answer2);
			Answer2Button.addActionListener(new Answer2ButtonListener(CorrectAnswer,TotalCorrectAnswers,PlayerNumber));
...
class Answer1ButtonListener implements ActionListener{
	...
	public Answer1ButtonListener(Double CorrectAnswer,int TotalCorrectAnswers,double PlayerNumber) {
		...
		public void actionPerformed(ActionEvent e) {
			...
			PlayerNumber = 1;
			new Question2Frame(AllQuestions,PlayerNumber,TotalCorrectAnswers);
		...
		public Answer2ButtonListener(Double CorrectAnswer,int TotalCorrectAnswers,double PlayerNumber) {
	        this.CorrectAnswer = CorrectAnswer;
